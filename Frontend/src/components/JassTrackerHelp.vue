  ...
  <div class="container mx-auto text-center">
    ...
    <div class="flex py-2">
      <div class="text-left flex-wrap">
        ...
        <p>
          Unter dem
          <RouterLink to="/profile" class="underline text-blue-600"
            >Profil</RouterLink
          >
          kann man seine Benutzerdaten anpassen und sieht auch persönliche
          Statistiken wie die durchschnittliche Punktzahl pro Trumpf und die
          Häufigkeit von Punktzahlen.
          <br />
          Der "Benutzername" lässt sich nicht anpassen, nachdem er initial
          gesetzt wurde.
          <br />
          Die Statistiken zeigen auf einem Tisch generelle Statistiken an wie
