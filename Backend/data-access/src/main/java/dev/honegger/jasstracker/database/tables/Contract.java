...
public class Contract extends TableImpl<ContractRecord> {
     ...
     */
    public final TableField<ContractRecord, ContractType> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(dev.honegger.jasstracker.database.enums.ContractType.class), this, "");
