...
public class Game extends TableImpl<GameRecord> {
    ...
    private transient dev.honegger.jasstracker.database.tables.Table _table;

    /**
     * Get the implicit join path to the <code>public.table</code> table.
     */
    public dev.honegger.jasstracker.database.tables.Table table() {
        if (_table == null)
            _table = new dev.honegger.jasstracker.database.tables.Table(this, Keys.GAME__GAME_TABLE_ID_FKEY);
