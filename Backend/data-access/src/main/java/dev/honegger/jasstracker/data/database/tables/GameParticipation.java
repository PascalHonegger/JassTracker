...
public class GameParticipation extends TableImpl<GameParticipationRecord> {
    ...
    public GameParticipation where(Condition condition) {
        return new GameParticipation(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public GameParticipation whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public GameParticipation whereNotExists(TableLike<?> select) {
