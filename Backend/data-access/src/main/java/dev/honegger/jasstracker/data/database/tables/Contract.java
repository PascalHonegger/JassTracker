...
public class Contract extends TableImpl<ContractRecord> {
    ...
    public Contract where(Condition condition) {
        return new Contract(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Contract whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Contract whereNotExists(TableLike<?> select) {
