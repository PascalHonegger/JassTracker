...
% JassTracker will take over the calculation for you and display whose turn it is for the upcoming round.
...
% The idea is, that during the time while a person is shuffling the cards for the next round, a second player will be entering the points in the JassTracker.
